...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        # 2. Obtener el decodificador de manera limpia
        ...
        elif 'model' in locals() and hasattr(model, 'dataset_infos'):
            decoder_info = model.dataset_infos
        else:
            # Instanciar solo si no existía previamente en memoria
            decoder_info = TADFDatasetInfos()
